...
public class GuardarrailIzquierdo extends ObjetoDeMapa{	
	
	public GuardarrailIzquierdo(int x, int y) {	
		...
		Image spriteImages = new Image("file:src/main/resources/img/guardarail-izq.png", width, height, false, false);
